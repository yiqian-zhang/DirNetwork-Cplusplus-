...
template <class ElemType, class WeightType>
int AdjListDirNetwork<ElemType, WeightType>::CountOutDegree(int v) const
{
    int count=0;
    if (v >= 0 && v < vexNum){
        AdjListNetworkArc<WeightType> *p;
...
template <class ElemType, class WeightType>
int AdjListDirNetwork<ElemType, WeightType>::CountInDegree(int u) const
{
    int count=0;
    if (u >= 0 && u < vexNum){
        AdjListNetworkArc<WeightType> *p;
